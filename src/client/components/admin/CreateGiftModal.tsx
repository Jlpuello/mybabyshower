...
export const CreateGiftModal = ({ isOpen, onClose, onSuccess }: CreateGiftModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.message || 'Error al crear el regalo');
      }

      const gift: GiftRow = await res.json();
      onSuccess(gift);
      handleClose();
    } catch (err) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Agregar regalo" size="lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-textLight">
                {maxReservations === 1
                  ? 'Solo 1 persona podrá reservarlo'
                  : `Hasta ${maxReservations} personas podrán reservarlo`}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            {imagePreview ? (
              ...
              >
                ...
                <p className="text-sm font-medium text-textSecondary">Subir imagen</p>
